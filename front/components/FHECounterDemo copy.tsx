...
export const FHECounterDemo = () => {
  ...
  return (
    <div id="title" className="grid w-full gap-4">
      ...
      <div id="account" className="col-span-full mx-20 mt-4 px-5 pb-4 rounded-lg bg-white border-2 border-black">
      ...
      <div id="instance" className="col-span-full mx-20">
        <div className="grid grid-cols-2 gap-4">
          ...
          <div id="Status" className="rounded-lg bg-white border-2 border-black pb-4 px-4">
      ...
      <div id="Count Handle"  className="col-span-full mx-20 px-4 pb-4 rounded-lg bg-white border-2 border-black">
      ...
      <div id="Decrypt" className="grid grid-cols-2 mx-20 gap-4">
        <button
          className={buttonClass}
      ...
      <div id="vite" className="grid grid-cols-2 mx-20 gap-4">
        <button
          className={buttonClass}
